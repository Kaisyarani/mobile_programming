...
public class ScannerActivity extends AppCompatActivity {
    ...
    public void submitaann (View view) {
        Intent intent = new Intent(ScannerActivity.this, inscanfek.class);
        startActivity(intent);
    }

    public void cancelajahlah (View view) {
        Intent intent = new Intent(ScannerActivity.this, inscan.class);
        startActivity(intent);
    }
}